...
Your project may use any language. It reads current observations and returns one decision at a time. Model calls are optional. See [Docs](/docs) for the interface and an example project.
